...
var __gwtModuleFunction = $wnd.OERC_Dashboard_widgetset_OercWidgetset;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.OERC.Dashboard.widgetset.OercWidgetset=");
    idx += (13 + "OERC.Dashboard.widgetset.OercWidgetset".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=OERC.Dashboard.widgetset.OercWidgetset-0.js
