...
public class HundStreamResource implements ConnectorResource {
	     ...
	     */
	    public HundStreamResource(StreamSource streamSource, String filename) {
	   ...
	   // @FunctionalInterface
	    ...
	    public boolean equals(Object obj) {
	        if (this == obj) {
	            return true;
	        } else if (obj instanceof HundStreamResource) {
	            HundStreamResource that = (HundStreamResource) obj;
