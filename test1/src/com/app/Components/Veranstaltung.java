...
public class Veranstaltung extends CustomComponent implements
	...
	private Panel createFirstPanel() {
		...
		veranstaltungsComboContainer = new BeanItemContainer<VeranstaltungsBean>(
	...
	private class AnmeldungsPanel extends CustomComponent {
		...
		public AnmeldungsPanel(VeranstaltungsStufen defStufeUeber,
			...
			printMeldungButton.setWidth("-1px");
			printMeldungButton.setHeight("-1px");
		...
		public void buildTableRow(Item veranstaltungsTeilnehmerItem) {
			...
			final TextArea punkteUebung1 = new TextArea();
			...
			punkteUebung1.setWidth("-1px");
			punkteUebung1.setHeight("-1px");
			punkteUebung1.setRows(1);
			...
			final TextArea punkteUebung2 = new TextArea();
			...
			punkteUebung2.setWidth("-1px");
			punkteUebung2.setHeight("-1px");
			punkteUebung2.setRows(1);
			...
			final TextArea punkteUebung3 = new TextArea();
			...
			punkteUebung3.setWidth("-1px");
			punkteUebung3.setHeight("-1px");
			punkteUebung3.setRows(1);
			...
			final TextArea punkteUebung4 = new TextArea();
			...
			punkteUebung4.setWidth("-1px");
			punkteUebung4.setHeight("-1px");
			punkteUebung4.setRows(1);
			...
			final TextArea punkteUebung5 = new TextArea();
			...
			punkteUebung5.setWidth("-1px");
			punkteUebung5.setHeight("-1px");
			punkteUebung5.setRows(1);
			...
			final TextArea punkteUebung6 = new TextArea();
			...
			punkteUebung6.setWidth("-1px");
			punkteUebung6.setHeight("-1px");
			punkteUebung6.setRows(1);
			...
			final TextArea punkteUebung7 = new TextArea();
			...
			punkteUebung7.setWidth("-1px");
			punkteUebung7.setHeight("-1px");
			punkteUebung7.setRows(1);
