...
public enum VeranstaltungsStationen {
	...
	TRAIN_WT_ANFAENGER(
			14,
			VeranstaltungsStation.TRAIN_WT_UE1,
			VeranstaltungsStation.TRAIN_WT_UE2,
			VeranstaltungsStation.TRAIN_WT_UE3,
			VeranstaltungsStation.TRAIN_WT_UE4,
			VeranstaltungsStation.TRAIN_WT_UE5,
			VeranstaltungsStation.TRAIN_WT_UE6,
			VeranstaltungsStation.TRAIN_WT_UE7,
			VeranstaltungsStation.TRAIN_WT_UE8),
	TRAIN_WT_FORTGESCHRITTEN(
			15,
			VeranstaltungsStation.TRAIN_WT_UE1,
			VeranstaltungsStation.TRAIN_WT_UE2,
			VeranstaltungsStation.TRAIN_WT_UE3,
