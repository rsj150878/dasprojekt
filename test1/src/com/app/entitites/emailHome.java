...
public class emailHome {
	...
	public email merge(email detachedInstance) {
		...
		try {
			email result = (email) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public email findById(int id) {
		...
		try {
			email instance = (email) sessionFactory.getCurrentSession().get("email", id);
			if (instance == null) {
	...
	public List findByExample(email instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("email").add(Example.create(instance))
					.list();
