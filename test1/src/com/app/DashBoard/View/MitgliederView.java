...
public class MitgliederView extends VerticalLayout implements View {
    ...
    private Table buildTable() {
        ...
        table.setContainerDataSource(new TempTransactionsContainer(DataProvider.getMitgliederList()));
        ...
        table.setVisibleColumns("vorName", "familienName", "adresse", "hundeNamen"); //, "ort", "strasse",
                //"hausnummer");
        table.setColumnHeaders("Vorname", "Nachname", "Adresse", "Hunde"); //, "Ort", "Strasse",
        ...
        table.addValueChangeListener(new ValueChangeListener() {
            ...
            public void valueChange(final ValueChangeEvent event) {
                if (table.getValue() instanceof Set) {
                    ...
                    neuesMitglied.setEnabled(val.size() > 0);
                }
            }
        });
...
//    }
    ...
    private class TempTransactionsContainer extends
            FilterableListContainer<MitgliederListe> {
        ...
        public void sort(final Object[] propertyId, final boolean[] ascending) {
            ...
            Collections.sort(getBackingList(), new Comparator<MitgliederListe>() {
                @Override
                public int compare(final MitgliederListe o1, final MitgliederListe o2) {
                    int result = 0;
                    if ("vorName".equals(sortContainerPropertyId)) {
                        result = o1.getVorName().compareTo(o2.getVorName());
                    } else if ("Familien".equals(sortContainerPropertyId)) {
                        result = o1.getFamilienName().compareTo(o2.getFamilienName());
                    }                      
