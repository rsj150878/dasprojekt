...
/**
 * schulter generated by hbm2java
 */
public class schulter implements java.io.Serializable {
	...
	public schulter(int id, String name, String oberkategorie, String unterkategorie, String merkmal, String status) {
		this.id = id;
		this.name = name;
	...
	public schulter(int id, String name, String oberkategorie, String unterkategorie, String merkmal, String wert,
