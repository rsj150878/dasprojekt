...
public class GAP1RichterBlatt extends CustomComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4566361292685535551L;
	...
	public GAP1RichterBlatt(Veranstaltung veranstaltung, VeranstaltungsStufe veranstaltungsStufe) {
	...
	private void bauPdf(Veranstaltung veranstaltung, VeranstaltungsStufe veranstaltungsStufe) throws Exception {
		...
		for (VeranstaltungsTeilnehmer zw : teilnehmer) {
			...
			if (hund.getBhdatum() != null) {
				fields.get("BH/BGH").setValue(dateFormat1.format(hund.getBhdatum()));
			}
