...
import com.app.DashBoard.View.VeranstaltungsDetailViewNeu.VeranstaltungsDetailListener;
...
import com.app.printClasses.WesentestBericht;
...
public class VeranstaltungsDetailViewNeu extends CustomComponent implements
	 ...
	 * editor.
	 */
	public VeranstaltungsDetailViewNeu(VeranstaltungsTypen typ,
			Item currentVeranstaltungsItem,
	...
	private void buildMainLayout() {
		...
		try {
			...
			veranstaltungsContainer.addContainerFilter(new Equal(
					"id_veranstaltung", currentVeranstaltungsItem
							.getItemProperty("id_veranstaltung").getValue()));
			currentVeranstaltungsItem = veranstaltungsContainer
					.getItem(veranstaltungsContainer.firstItemId());
	...
	private Panel createSecondPanel() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				title += " "
						+ new SimpleDateFormat("dd.MM.yyyy")
								.format(currentVeranstaltungsItem
		...
		printBewertungsListeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				BewertungsListeNeu bewertungsListe = new BewertungsListeNeu(
						currentVeranstaltungsItem);
		...
		public AnmeldungsPanel(VeranstaltungsStufen defStufeUeber,
			...
			printRichterBlattButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					Class<? extends CustomComponent> printClass = defStufe
							.getRichterBlatt();

					if (!(printClass == null)) {
						try {
							Component printObject = printClass.getConstructor(
									Item.class, Item.class).newInstance(
							...
							e.printStackTrace();
							Notification
									.show("fehler beim laden der Druckklasse");
						}
					} else {
					...
					//
					// } else if
					// (defStufe.equals(VeranstaltungsStufen.STUFE_RBP1)) {
					...
					//
					// } else if
					// (defStufe.equals(VeranstaltungsStufen.STUFE_GAP1)) {
			...
			printUrkundenButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					if (defStufe
						...
						UrkundeTrainingsWorkingtest urkunde = new UrkundeTrainingsWorkingtest(
								veranstaltung, veranstaltungsStufe);
						anmeldungsPanelLayout.addComponent(urkunde);
						currentPrintComponent = urkunde;

					} else if (defStufe
							.equals(VeranstaltungsStufen.WESENSTEST_GRUPPE_ALLGEMEIN)) {
						WesentestBericht urkunde = new WesentestBericht(
								veranstaltung, veranstaltungsStufe);
						anmeldungsPanelLayout.addComponent(urkunde);
						currentPrintComponent = urkunde;
			...
			anmeldungsGrid = new VeranstaltungsTeilnehmerGrid(defStufe,
					veranstaltungsStufe);
