...
/**
 * huefte generated by hbm2java
 */
public class huefte implements java.io.Serializable {
	...
	public huefte(int id, String name, String oberkategorie, String unterkategorie, String merkmal, String status) {
		this.id = id;
		this.name = name;
	...
	public huefte(int id, String name, String oberkategorie, String unterkategorie, String merkmal, String wert,
			String datum, String bemerkung, String quelle, String status, Character dummy) {
		this.id = id;
		this.name = name;
		this.oberkategorie = oberkategorie;
		this.unterkategorie = unterkategorie;
