...
public class GAP1RichterBlatt extends CustomComponent {

	/** The original PDF file. */
	public static final String DATASHEET = "files/GAP-1_Richterblatt_FORMULAR.pdf";
	...
	public GAP1RichterBlatt(Item veranstaltung, Item veranstaltungsStufe) {
	...
	private void bauPdf(Item veranstaltung, Item veranstaltungsStufe) throws Exception {
		...
		for (Object id : teilnehmerContainer.getItemIds()) {
			...
			if (hundContainer.getItem(hundContainer.firstItemId()).getItemProperty("bhdatum").getValue() != null) {
				fields.get("BH/BGH").setValue(dateFormat1.format(
						hundContainer.getItem(hundContainer.firstItemId()).getItemProperty("bhdatum").getValue()));
			}
