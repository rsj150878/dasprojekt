...
public class UserDetail extends CustomComponent {
	...
	public UserDetail(Item personItem) {
		buildMainLayout();
		setCompositionRoot(mainLayout);
	...
	public void setInit() {
		...
		this.newsletter.setValue(personItem.getItemProperty("newsletter") == null || personItem.getItemProperty("newsletter")
				.getValue().toString().equals(new String("J")) ? true : false);
		...
		this.newsletter.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				personItem.getItemProperty("newsletter").setValue((
						newsletter.getValue() == true) ? new String("J") : new String("N"));
			}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(nachname, "top:80.0px;left:120.0px;");
		...
		mainLayout.addComponent(Vorname, "top:80.0px;left:300.0px;");
		...
		mainLayout.addComponent(Strasse, "top:120.0px;left:120.0px;");
		...
		mainLayout.addComponent(hnr, "top:120.0px;left:300.0px;");
		...
		mainLayout.addComponent(plz, "top:160.0px;left:120.0px;");
		...
		mainLayout.addComponent(Ort, "top:160.0px;left:300.0px;");
		...
		mainLayout.addComponent(gebdat, "top:200.0px;left:120.0px;");
		...
		land.setWidth("-1px");
		land.setHeight("-1px");
		mainLayout.addComponent(land, "top:240.0px;left:120.0px;");
		...
		mainLayout.addComponent(email, "top:236.0px;left:300.0px;");
		...
		ok.setWidth("-1px");
		ok.setHeight("-1px");
		mainLayout.addComponent(ok, "top:320.0px;left:120.0px;");
		...
		mainLayout.addComponent(Abbruch, "top:320.0px;left:300.0px;");
		...
		mainLayout.addComponent(newsletter, "top:284.0px;left:120.0px;");
